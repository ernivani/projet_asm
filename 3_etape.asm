...
;affichage couleur en hexa
affichage_couleur db "Couleur : 0x%x", 10, 0 ; Format string for printf
...
boucle_points:
    ...
    ; Afficher la couleur en hexadécimal
    mov rdi, affichage_couleur  ; Load the format string into rdi
    mov rsi, rax                ; Load the color value into rsi
